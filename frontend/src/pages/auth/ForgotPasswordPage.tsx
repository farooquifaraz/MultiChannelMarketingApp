...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ignore — same neutral flow either way (no account enumeration)
    } finally {
      setLoading(false);
    }
    toast.success('If an account exists, a 6-digit code has been emailed.');
    // Move to the reset page carrying the email; the code is entered there.
